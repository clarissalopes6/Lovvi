...
/* Script de manutencao das rotinas do banco.

   Use este arquivo depois que o banco ja estiver criado e populado.
   Ele nao recria as tabelas principais e nao executa inserts de carga inicial,
   portanto preserva usuarios, perfis, interesses, matches e demais dados
   cadastrados pela interface.

   O que este script pode substituir:
   - views;
   - indices;
   - funcoes;
   - procedimentos;
   - triggers;
   - tabela auxiliar log_match, criada apenas se ainda nao existir.
*/
...
/* Usuarios com pelo menos um match acima da media geral. */
