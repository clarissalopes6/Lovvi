...
('Psicologia e comportamento humano.', 'Alguem empatico', 'Relacionamento serio', 'relacionamento', 1.64, 14),
...
('Artesa e empreendedora criativa.', 'Alguem criativo', 'Amizade', 'amizade', 1.60, 30),
...
('Qual importancia tem dinheiro para voce?',        'Valores', 7),
